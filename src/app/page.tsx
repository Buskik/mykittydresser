	...
	return (
		<>
			...
			<main className="flex w-screen h-screen items-center justify-center gap-10 bg-pink-950">
				{/* LEFT MENU */}
				<div
					className={`${leftOpen && "pointer-events-none opacity-0"} min-h-72 min-w-48 transition-all duration-500  flex flex-col justify-between items-end`}
				>
					<Icon
						icon={Shirt}
						onClick={() => {
				...
				{/* FACES MENU */}
				<div
					className={`${!faceOpen && "pointer-events-none opacity-0 w-0"} flex flex-col relative min-w-[24rem] transition-all duration-500	 rounded-md overflow-hidden `}
				>
				...
				{/* CLOTHES MENU */}
				<div
					className={`${!clothOpen && "pointer-events-none opacity-0 w-0"} flex transition-all duration-500 flex-col relative min-w-[24rem] rounded-md overflow-hidden `}
				>
					<div className="sticky bg-pink-200 text-pink-950 p-4 w-full  top-0 left-0 right-0 flex justify-between">
				...
				{/* ACESSORIES MENU */}
				<div
					className={`${!acessOpen && "pointer-events-none opacity-0 w-0"} flex transition-all duration-500 flex-col relative min-w-[24rem] rounded-md overflow-hidden `}
				>
					<div className="sticky bg-pink-200 text-pink-950 p-4 w-full  top-0 left-0 right-0 flex justify-between">
				...
				{/* SHOES MENU */}
				<div
					className={`${!shoeOpen && "pointer-events-none opacity-0 w-0"} flex flex-col relative min-w-[24rem] transition-all duration-500 rounded-md overflow-hidden `}
				>
					<div className="sticky bg-pink-200 text-pink-950 p-4 w-full  top-0 left-0 right-0 flex justify-between">
